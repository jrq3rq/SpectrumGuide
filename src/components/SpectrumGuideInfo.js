      ...
      <div className="spectrum-guide-container">
        ...
        <div className={`info-content ${isOpen ? "open" : "closed"}`}>
          <div className="info-inner">
            ...
            <p>
              Spectrum Guide is an innovative AI tool designed to support
              parents, caregivers, educators, and professionals in nurturing
              individuals with autism. It provides personalized insights,
              tailored recommendations, and actionable plans to enhance
              understanding and manage daily challenges effectively.
            </p>
            ...
            <p>
              ...
              strengths, and challenges. Our mission is to empower those
              involved in their care with AI-driven tools, fostering
            ...
            <p className="pay-per-use">
              ...
              specific services or features. This model allows you to pay only
              for what you use, making personalized support more accessible and
            ...
            <p className="privacy-security">
              ...
              progress, chat history, and personalized insights, does not
              transfer between devices. For continuity, we recommend using the
              same device for all interactions with Spectrum Guide.
            </p>

            <h3>Our Suite of Features</h3>
            <ul>
              <li>
                <strong>Customized Care Plans:</strong> Tailor daily routines
                and strategies to match individual strengths, sensory
                preferences, and triggers, fostering a supportive environment.
              </li>
              <li>
                <strong>Educational Support:</strong> Develop personalized
                learning approaches or Individualized Education Plans (IEPs)
                that align with communication styles, learning methods, and
                interests for optimal educational outcomes.
              </li>
              <li>
            ...
            <p className="privacy-data-security">
              ...
              control over sensitive information. However, consider these
              points:
              <ul>
                <li>
                  <em>Storage Limitation:</em> You're limited by your device's
                  storage capacity. You may need to manage or delete older data
            ...
            <p className="foundation-text">
              Sponsored by The Spectrum Foundation
            </p>
          </div>
        </div>
      </div>
