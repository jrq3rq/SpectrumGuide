...
const planDisplayDescriptions = {
  ...
  starter: "Silver Spectrum: 10 credits.",
  family: "Gold Spectrum: 50 credits.",
};
// Plan Descriptions for Tooltips
const planTooltips = {
  free: "This plan offers basic access to our AI features with no additional costs. Ideal for testing the waters.",
  starter:
    "With 10 credits, you can enjoy up to 10 custom AI sessions. Great for personal use or small projects.",
  family:
    "50 credits provide extensive interaction capabilities, perfect for families or groups needing more AI support.",
};
    ...
    <div className="signup-page">
      ...
      {clientSecret && selectedPlan !== "free" && (
        <Elements stripe={stripePromise} options={{ clientSecret }}>
          <PaymentComponent
            plan={selectedPlan}
            amount={selectedPlan === "starter" ? 9.99 : 29.99}
            onSuccess={() => {
