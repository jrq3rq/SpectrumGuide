...
//         }
//       }
//       // Add new story at the beginning so newest appear first
...
//     } finally {
//       setIsGenerating(false);
//       setIsLoading(false); // Stop the loading overlay
//     }
//   };
...
//                 .reverse() // Reverse the order so the most recent comes first
//                 .map((msg) => (
