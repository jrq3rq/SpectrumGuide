...
//     pecsDownloads: 0,
//     pecsGenerations: 0,
//     pecsUploads: 0, // Added for tracking PECS uploads
//   });
...
//     pecsDownload: 0.5,
//     pecsGenerate: 0.25,
//     pecsUpload: 0.5, // Cost for uploading a pre-made board
//   };
...
//       } catch (error) {
//         console.error("UserContext: Storage sync error:", error);
//         setCreditError("Failed to update credits. Please try again.");
//       }
//     },
//     [user?.uid]
//   );
...
//     async (amount, feature = null) => {
//       if (!isAuthenticated || !user) {
//         setCreditError("User not authenticated.");
//         return false;
//       }
...
//         if (!userSnap.exists()) {
//           setCreditError("User data not found.");
//           return false;
//         }
...
//         let newAiUsage = { ...aiUsage };

//         if (feature) {
//           const currentCount = parseFloat(aiUsage[feature] || 0);
//           newAiUsage = {
//             ...aiUsage,
...
//         setCreditError("Failed to deduct credits. Please try again.");
//         return false;
//       }
//     },
//     [isAuthenticated, user, aiUsage]
//   );
...
//       if (!cost) {
//         console.error("UserContext: Unknown feature:", feature);
//         setCreditError("Invalid feature.");
//         return false;
//       }
...
//         setProfileFormResponses,
//         notes,
//         CREDIT_COSTS, // Expose credit costs
//       }}
//     >
//       {children}
//     </UserContext.Provider>
  ...
  useEffect(() => {
    const unsubscribeAuth = onAuthStateChanged(auth, async (firebaseUser) => {
      if (firebaseUser) {
        ...
        localStorage.removeItem("uid");
        sessionStorage.clear();
        // Allow /signin, /signup, /investors for unauthenticated users
        if (
          location.pathname !== "/signin" &&
          location.pathname !== "/signup" &&
